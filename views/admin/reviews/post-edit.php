...
if ($image_review) {
    ...
    $sql = "UPDATE reviews SET variant_product_id = '$variant_product_id', user_id = '$user_id', star = '$star', description_review = '$description_review', image_review = '$upload_file' WHERE id_review = '$id_review'";
} else {
