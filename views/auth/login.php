...
<head>
    <meta charset="UTF-8">
    <title>MdwiShop | Form Login</title>
                ...
                <div class="relative overflow-hidden rounded-md shadow bg-white ">
                    <div class="grid md:grid-cols-2 grid-cols-1 items-center">
                        <div class="relative md:shrink-0">
                            <img class="h-full w-full object-cover md:h-[44rem]" src="./../assets/images/ms-login-banner.jpg" alt="">
                        </div>
                        ...
                        <div class="p-8 lg:px-20">
                            ...
                            <form class="text-start lg:py-20 py-8" action="./post-login.php" method="POST">
                                <div class="grid grid-cols-1">
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        <button type="submit" class="py-2 px-5 inline-block tracking-wide align-middle duration-500 text-base text-center bg-orange-500 text-white rounded-md w-full">Login</button>
                                    </div>

                                    <div class="text-center">
                                        <span class="text-slate-400 me-2">Don't have an account ? </span> <a href="./register.php" class="text-black font-bold inline-block">Sign Up</a>
                                    </div>
                                </div>
                            </form>
