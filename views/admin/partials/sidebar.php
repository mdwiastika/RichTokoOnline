     ...
     <div class="sidebar-wrapper">
         <nav class="mt-2">
             <ul class="nav sidebar-menu nav-sidebar flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                 ...
                 <li class="nav-item <?= $title == 'Manajemen Transactions' ? 'menu-open' : '' ?>"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-credit-card-2-front"></i>
                         <p>
                             Transactions
                             <i class="nav-arrow bi bi-chevron-right"></i>
                         </p>
                     ...
                     <ul class="nav nav-treeview">
                         <li class="nav-item"> <a href="/admin/transactions" class="nav-link <?= $sub_title == 'Manajemen Transactions' ? 'active' : '' ?>"> <i class="nav-icon bi bi-circle"></i>
